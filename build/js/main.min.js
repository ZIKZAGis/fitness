...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_slider__WEBPACK_IMPORTED_MODULE_3__["init"])(); // Modules
  // ---------------------------------
...
var slides = document.querySelectorAll('.coaches__slider-line > div');
var sliderLine = document.querySelector('.coaches__slider-line');
var slider = document.querySelector('.coaches__slider');
var count = 0;
var width = document.querySelector('.coaches__slider-line > div').offsetWidth;
...
document.querySelector('.coaches__slider-button--prev').addEventListener('click', function () {
  count--;
...
document.querySelector('.coaches__slider-button--next').addEventListener('click', function () {
  count++;
